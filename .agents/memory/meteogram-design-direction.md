...
Weather icons must always include an intentional cloud shape, use sun only during daylight, use moon/night treatment after dark, show rain drops only for rainy states, and render above the temperature fill.