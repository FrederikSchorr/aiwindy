...
The section-4 loading state must match the bare animated three-dot loader used in section 3. Render it as soon as the recognized-location analysis view appears, with no box, wrapper spacing, weather icon, or visible preparation text.
