...
The temperature fill must be bounded below by the dew-point curve, with dew-point values placed immediately underneath. Do not use horizontal row separators or horizontal chart grid lines; retain only meaningful vertical boundaries such as day changes.