...
- Bullet Heute und Bullet Morgen: jeweils Wind und die passende Welle/Dünung aus preprocessed.local.wave im selben Bullet. Direkt nach dem Zeit-/Datumspräfix steht "💨" vor dem Windtext; direkt vor der Welle steht "🌊". Wind detailliert mit zeitlichen Änderungen, Richtung, Stärke in Knoten und Böen. Welle in Douglas-Skala, KEINE Meter. Nur explizite Wellendaten verwenden, niemals schätzen.
