...
- Welle: max 2 Bullets. Quellen: preprocessed.local.wave (OpenSkiron WAM — Douglas-Skala bereits umgerechnet, Heute/Morgen/Übermorgen) ODER preprocessed.local.warnings/sailingareaForecast. Douglas-Skala verwenden (1=ruhig…6=sehr rau), KEINE Meter. Bei wave-Daten Zeitbezug aus den Daten übernehmen. NUR wenn explizite Wellendaten vorhanden — NIEMALS schätzen. Weglassen wenn keine Daten.
