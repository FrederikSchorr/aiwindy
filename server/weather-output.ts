...
- Bullet Heute und Bullet Morgen: jeweils Wind und die passende Seegangsstärke aus preprocessed.local.wave im selben Bullet. Direkt nach dem Zeit-/Datumspräfix steht "💨" vor dem Windtext; direkt vor der Welle steht "🌊". Nenne zuerst das Windsystem (z.B. "Maïstrali"), danach höchstens die zwei wichtigsten Windphasen als kompakte Bereiche. Kombiniere Mittelwind und Böe IMMER zu einem Bereich im Format "WNW 14-18 kt"; schreibe niemals "Böen", "mit Böen", "bis", genaue Uhrzeiten oder Tageszeiten wie "morgens/abends". Welle nur als Douglas-Skala (z.B. "See 2 schwach bewegt"), KEINE Richtung, Periode oder Dünung. Nur explizite Wellendaten verwenden, niemals schätzen.
...
- Bullet Danach (bis ${forecastEndLabel}): beginne mit dem Datumsbereich der drei verbleibenden Tage (z.B. "Di–Do 25.–27.08.:"). Setze danach "💨" vor die großflächige Zusammenfassung; nenne für jeden Tag ausschließlich die Windstärke-Kategorie (stürmisch, kräftig, mäßig, schwach oder Flaute), ohne Richtungen und ohne Stundenwerte. Richtungsangaben wie N, NO, NW, W, S usw. sind in diesem Bullet VERBOTEN. Erwartetes Schema: "Di mäßig; Mi schwach bis mäßig; Do stürmisch."
